...
export class MemStorage implements IStorage {
  ...
  private initializeSampleData() {
    // Beauty workspace categories with proper organization
    const sampleWorkspaces: InsertWorkspace[] = [
      // MAKEUP SERVICES
      {
        name: "Makeup Studio - Wien 1040",
        category: "makeup",
      ...
      {
        name: "Kosmetikraum Premium Wien 1070",
        category: "kosmetik",
      ...
      {
        name: "Kosmetikraum Deluxe Wien 1070",
        category: "kosmetik",
      ...
      // NAGELDESIGN SERVICES
      {
        name: "Nageldesign Studio Wien 1040",
      ...
      // FUSSPFLEGE SERVICES
      {
        name: "Fußpflege Studio Wien 1070",
        category: "fußpflege",
